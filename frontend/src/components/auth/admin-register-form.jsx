...
export function AdminRegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3.5">
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 h-10 rounded-xl text-sm border-slate-200 focus-visible:ring-[#EA580C]"
            required
          />
        </div>
      </div>
      ...
      {/* Email / Admin ID */}
      <div className="space-y-1">
        <label className="text-xs font-semibold text-foreground">Email / Admin ID</label>
        <div className="relative">
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-10 h-10 rounded-xl text-sm border-slate-200 focus-visible:ring-[#EA580C]"
            required
          />
          <button
            type="button"
      ...
      <Button
        type="submit"
        className="w-full h-11 text-sm font-semibold rounded-xl bg-[#EA580C] hover:bg-[#C2410C] text-white shadow-md shadow-orange-500/20 mt-2"
        disabled={isLoading}
      >
        {isLoading ? (
          <>
