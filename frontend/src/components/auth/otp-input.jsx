    ...
    <div className="flex items-center justify-between gap-2 sm:gap-3" onPaste={handlePaste}>
      {Array.from({ length }).map((_, index) => (
        <Input
          ...
          className="size-9 sm:size-10 p-0 text-center text-sm font-bold focus-visible:ring-2 focus-visible:ring-[#5E46E8] rounded-xl border-slate-300 dark:border-slate-700"
