...
export function SiteHeader({ onOpenLogin }) {
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          {isAuthenticated ? (
            ...
            <Button
              onClick={onOpenLogin}
              render={!onOpenLogin ? <Link href="/login" /> : undefined}
              size="sm"
              className="bg-[#5E46E8] hover:bg-[#4E36D8] text-white font-semibold rounded-xl px-5 py-2 shadow-md shadow-indigo-500/20 cursor-pointer"
            >
              Login
            </Button>
          )}
            ...
            <div className="mt-2 flex flex-col gap-2">
              {isAuthenticated ? (
                ...
                <Button
                  ...
                  render={!onOpenLogin ? <Link href="/login" /> : undefined}
                  className="w-full bg-[#5E46E8] hover:bg-[#4E36D8] text-white font-semibold rounded-xl"
                >
                  Login
                </Button>
              )}
