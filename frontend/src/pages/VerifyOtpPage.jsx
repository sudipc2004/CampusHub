    ...
    <AuthLayoutWrapper>
      ...
      >
        <form onSubmit={handleVerify} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[11px] font-semibold text-[#5E46E8] hover:underline cursor-pointer"
              >
          ...
          <Button
            type="submit"
            className="w-full h-11 text-sm font-semibold rounded-xl bg-[#5E46E8] hover:bg-[#4E36D8] text-white shadow-md shadow-indigo-500/20 cursor-pointer"
